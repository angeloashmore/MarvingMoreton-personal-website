  ...
  <div className="container">
    <div className={classes["flex-box"]}>
      <div className={classes["image-side"]}>
        <PrismicNextImage field={slice.primary.illustration} className={classes["illustration"]}/>

        <div className={classes["image-box"]}>
          <PrismicNextImage field={slice.primary.image} className={classes["hero-image"]}  />
        </div>
      </div>
